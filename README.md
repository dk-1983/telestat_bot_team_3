...
Статистика обрабатывается и отправляется в Google 
...
администратора бота. Администратор бота в свою очередь может управлять ботом после занесения администратора в базу данных, администраторов может быть несколько. Владелец программного обеспечения управляет администраторами, администраторы управляют ботом. Бот работает в канале и незаметен для пользователей канала, с которого производится сбор 
