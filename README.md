...
### Проект telestat_bot - это два бота собирающие статистику о пользователях из телеграмм каналов владельца каналов либо тех каналов где бот зарегистрирован как
### администратор. Интерфейс управления ботом организован непосредственно через интерфейс телеграмм. Статистика обрабатывается и отправляется в Google 
